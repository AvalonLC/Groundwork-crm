-- 0067_marketing_send_attempts.sql — Marketing OS.
--
-- Adds a per-recipient attempt counter to the send snapshot.
--
-- Why this is not folded into 0065: the drain re-queues a batch when the
...
--
-- Kept as a separate migration rather than an edit to 0065 because 0065 may
