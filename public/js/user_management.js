...
const _UM_ROLE_DEFS_DEFAULT = [
  // ── 1. ADMIN ──────────────────────────────────────────────────────────────
  {
    ...
    defaultViews: ['today','myDashboard','teamView',
      ...
      'communications','automations','templates','campaigns','sequences','talkTracks','playbooks','aiAssist',
...
const UM_ALL_VIEWS = [
  ...
  { key:'communications',     label:'Communications (Inbox)',           hub:'Sales',       kind:'page'   },
  { key:'templates',          label:'Communications → Templates',       hub:'Sales',       kind:'page'   },
  { key:'sequences',          label:'Communications → Sequences',       hub:'Sales',       kind:'page'   },
  { key:'talkTracks',         label:'Communications → Talk Tracks',     hub:'Sales',       kind:'page'   },
  { key:'playbooks',          label:'Communications → Playbooks',       hub:'Sales',       kind:'page'   },
  { key:'aiAssist',           label:'Communications → AI Assist',       hub:'Sales',       kind:'page'   },
