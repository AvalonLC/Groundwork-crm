...
export async function approveChangeOrderWorkflow(
  ...
  const newRevision = {
    ...
    contract_value_cents: revised.contract_value_cents,
    labor_hours_budgeted_hundredths: laborHoursBudgetedHundredths,
    labor_rate_used: priorVersion?.labor_rate_used ?? null,
    materials_budget_cents: priorVersion?.materials_budget_cents ?? 0,
    subcontractor_budget_cents: priorVersion?.subcontractor_budget_cents ?? 0,
    equipment_budget_cents: priorVersion?.equipment_budget_cents ?? 0,
    disposal_budget_cents: priorVersion?.disposal_budget_cents ?? 0,
    permits_budget_cents: priorVersion?.permits_budget_cents ?? 0,
    other_direct_budget_cents: (priorVersion?.other_direct_budget_cents ?? 0) + co.direct_cost_adjustment_cents,
    direct_cost_budget_cents: revised.direct_cost_budget_cents,
    division,
    overhead_rate_used: overheadRateSnapshot,
    budgeted_overhead_cents: revised.budgeted_overhead_cents,
